    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                list.add(new ImageList(R.drawable.iamatomic));
                list.add(new ImageList(R.drawable.kingdom));
                list.add(new ImageList(R.drawable.jjsksen));
                list.add(new ImageList(R.drawable.kmy));
                list.add(new ImageList(R.drawable.onepice));
                list.add(new ImageList(R.drawable.naruto));
                list.add(new ImageList(R.drawable.spx));
                list.add(new ImageList(R.drawable.ssnofr));
                list.add(new ImageList(R.drawable.vchtkvg));
                list.add(new ImageList(R.drawable.frbk));
                list.add(new ImageList(R.drawable.berserk));
                list.add(new ImageList(R.drawable.cthloi));
